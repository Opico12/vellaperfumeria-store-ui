    ...
    if (this.state.hasError) {
      return (
        <div className="flex flex-col items-center justify-center min-h-screen bg-gray-50 text-center p-4">
          ...
          <p className="text-gray-600 mb-6">La tienda ha encontrado un error inesperado.</p>
          <button 
...
const AppContent: React.FC = () => {
    ...
    const buildBreadcrumbs = (): BreadcrumbItem[] => {
        ...
        const homeCrumb: BreadcrumbItem = { 
            label: 'Inicio', 
            onClick: () => handleNavigate('home'), // Use Internal Navigation
            target: '_self'
        };
        ...
        switch(view.current) {
            ...
            case 'checkoutSummary':
                ...
                break;
            case 'about':
                crumbs.push({ label: 'Sobre Nosotros' });
                break;
        }
